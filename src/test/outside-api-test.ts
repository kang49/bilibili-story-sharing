...
async function outsideAPITest () {
    //name test
    await fetchData('https://bilishare.kankawee.uk/bili-api/api?biliLink=That%20Time%20I%20Got%20Reincarnated%20as%20a%20Slime', 'kankawee.uk', 'name');
    ...
    // //link test
    await fetchData('https://bilishare.kankawee.uk/bili-api/api?biliLink=https://www.bilibili.tv/th/play/1018282', 'kankawee.uk', 'link');
